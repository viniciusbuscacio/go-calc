...
import { ui, update, api, go, loadSettings } from "./store";
...
<template>
  <div class="window">
    <header class="titlebar" style="--wails-draggable: drag">
      <div class="brand">
        <!-- The same calculator glyph as build/appicon-source.svg (Lucide
             "calculator", ISC licence), stroked with currentColor so it
        ...
        <span class="titlebar-title">go-Calc</span>
      </div>
