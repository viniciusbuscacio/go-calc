...
- Windows: `%AppData%\go-calc\settings.json`
- macOS: `~/Library/Application Support/go-calc/settings.json`
- Linux: `$XDG_CONFIG_HOME/go-calc/settings.json` (or `~/.config/...`)
...
- It can compute expressions and operate the visible UI (press buttons, send
